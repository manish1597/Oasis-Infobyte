...
public class ReservationSystem {
    ...
    public static void main(String[] args) {
        ...
        makeReservation();//Make reservation to make reservation
        login();
        if (isLoggedIn) {
    ...
    static void login() {//cheking it valid or not
    ...
    static void makeReservation() {//to make reservation
    ...
    static void cancelReservation() {//to cancel the reservation
